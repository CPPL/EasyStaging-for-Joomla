...
?>
		<tr class="rsync-settings row<?php echo $i % 2; ?>" id="<?php echo JFilterOutput::stringURLSafe($row['label']); ?>">
			<td>
				<input type="text" name="<?php echo $controlName . '[label]" value="' . $row['label']; ?>" size="60">
			...
			<td><input type="text" name="<?php echo $controlName . '[source_path]" value="' . $row['source_path']; ?>" size="60"></td>
			<td><input type="text" name="<?php echo $controlName . '[target_path]" value="' . $row['target_path']; ?>" size="60"></td>
		</tr>
<?php
}
