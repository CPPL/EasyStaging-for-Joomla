...
?>
<h3><?php echo JText::_( 'COM_EASYSTAGING_HOW_IT_WORKS___' ); ?><a href="javascript:void(0);"><span id="howitworkstoggle" title="<?php echo JHtml::tooltipText(JText::_('COM_EASYSTAGING_PLANS_HOW_IT_WORK_CLICK_HERE_TO_EXPAND')) ?>" class="hasTooltip"><?php echo JText::_('COM_EASYSTAGING_EXPANDER'); ?></span></a></h3>
